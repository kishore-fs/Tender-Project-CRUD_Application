...
export function Seafood(){
  ...
  useEffect(()=>{
    ...
    <div className="container col-md-10">
        <h1 className="text-danger">SEAFOOD</h1>
      ...
      {/* {Chickendetails.map((index,value)=>( */}
         ...
         <div className="row">
               <div className="p-3">
                 <img
                   src="https://assets.tendercuts.in/product/S/F/ace681e8-36d3-4d75-aa3d-cac0bdcb515d.jpg"
           ...
           <div className="card-body text-center">
               <div className="">
                 ...
                 <input type="text" className="btnConform" id="chicken" value="WhitePomfret"></input>
                 </div>
               </div>
             </div>
           </div>
      ...
      <div className="container col-md-3 text-center">
         ...
         <div className="row">
               <div className="p-3">
                 <img
                   src="https://assets.tendercuts.in/product/S/F/da08b3c1-d92a-49bb-8664-7db731ddc3d5.webp"
                   className="img-fluid rounded "
                   alt="..."
                   style={{ width: '13rem',height:'8rem' }}
                 />
           ...
           <div className="card-body text-center">
               <div className="">
                 ...
                 <div className="container col-md-12 p-2">
                 <input type="text" className="btnConform" id="boneless" value="AtlanticSalmon"></input>
                 </div>
               </div>
             </div>
           </div>
       ...
       <div className="container col-md-3 text-center">
         ...
         <div className="row">
               <div className="p-3">
                 <img
                   src="https://assets.tendercuts.in/product/R/M/d8d8e3b9-82cb-444f-a024-9cd20891a45d.webp"
                   className="img-fluid rounded "
                   alt="..."
                   style={{ width: '13rem',height:'8rem' }}
                 />
           ...
           <div className="card-body text-center">
               <div className="">
                 ...
                 <div className="container col-md-12 p-2">
                 <input type="text" className="btnConform" id="eeral" value="Prawns"></input>
                 </div>
               </div>
             </div>
           </div>
       ...
       <div className="container col-md-3 text-center">
         ...
         <div className="row">
               <div className="p-3">
                 <img
                   src="https://assets.tendercuts.in/product/S/F/15689b87-5df9-49d3-98b3-82a874df1930.webp"
                   className="img-fluid rounded "
                   alt="..."
                   style={{ width: '13rem',height:'8rem' }}
                 />
           ...
           <div className="card-body text-center">
               <div className="">
                 ...
                 <div className="container col-md-12 p-2">
                 <input type="text" className="btnConform" id="leg" value="Squid"></input>
                 </div>
               </div>
             </div>
           </div>
