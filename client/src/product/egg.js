...
export function Egg(){
  ...
  useEffect(()=>{
    ...
    <div className="container col-md-10">
        <h1 className="text-danger">EGG</h1>
      ...
      {/* {Chickendetails.map((index,value)=>( */}
         ...
         <div className="row">
               <div className="p-3">
                 <img
                   src="https://assets.tendercuts.in/product/c/h/chk_egg.jpg"
           ...
           <div className="card-body text-center">
               <div className="">
                 ...
                 <p className="card-text">30(pack of 6)</p>
                 ...
                 <input type="text" className="btnConform" id="chicken" value="WhiteEgg"></input>
                 </div>
               </div>
             </div>
           </div>
      ...
      <div className="container col-md-3 text-center">
         ...
         <div className="row">
               <div className="p-3">
                 <img
                   src="https://assets.tendercuts.in/product/c/h/chk_cntry_egg-base.jpg"
                   className="img-fluid rounded "
                   alt="..."
                   style={{ width: '13rem',height:'8rem' }}
                 />
           ...
           <div className="card-body text-center">
               <div className="">
                 ...
                 <div className="container col-md-12 p-2">
                 <input type="text" className="btnConform" id="boneless" value="CountryEgg"></input>
                 </div>
               </div>
             </div>
           </div>
       ...
       <div className="container col-md-3 text-center">
         ...
         <div className="row">
               <div className="p-3">
                 <img
                   src="https://assets.tendercuts.in/product/q/u/quail_eggs_329x210.jpg"
                   className="img-fluid rounded "
                   alt="..."
                   style={{ width: '13rem',height:'8rem' }}
                 />
           ...
           <div className="card-body text-center">
               <div className="">
                 ...
                 <div className="container col-md-12 p-2">
                 <input type="text" className="btnConform" id="eeral" value="QuailEgg"></input>
                 </div>
               </div>
             </div>
           </div>
       ...
       <div className="container col-md-3 text-center">
         ...
         <div className="row">
               <div className="p-3">
                 <img
                   src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQn5vQofE8Zm9ZttlGNI2CZwTHP3bT2LfhH7w&usqp=CAU"
                   className="img-fluid rounded "
                   alt="..."
                   style={{ width: '13rem',height:'8rem' }}
                 />
           ...
           <div className="card-body text-center">
               <div className="">
                 ...
                 <div className="container col-md-12 p-2">
                 <input type="text" className="btnConform" id="leg" value="MixedEgg"></input>
                 </div>
               </div>
             </div>
           </div>
